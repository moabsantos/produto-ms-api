...
, created_at: Date, created_by: number, updated_at: Date, updated_by: number, deleted_at: Date, deleted_by: number}[] = [
    ...
    getPermissaoAcesso({ code: 'geral-pedido-tipo-dig',      name: 'Geral - Tipo  de Pedido (Cadastro)', description: ''}),
    getPermissaoAcesso({ code: 'geral-pedido-tipo-get',      name: 'Geral - Tipo  de Pedido (Consulta)', description: ''}),
    ...
    getPermissaoAcesso({ code: 'com-pedido-venda-get',        name: 'Comercial - Pedido de Venda (Consulta)', description: ''}),
